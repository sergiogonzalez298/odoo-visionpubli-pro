odoo.define('theme_crafito.crafito_frontend_js', function(require) {
    ...
    animation.registry.theme_crafito_blog_custom_snippet = animation.Class.extend({
        ...
        start: function() {
            ...
            if (this.editableMode) {
                var $blog_snip = $('#wrapwrap').find('#theme_crafito_custom_blog_snippet');
            ...
            if (!this.editableMode) {
                ...
                $.get("/theme_crafito/blog_get_dynamic_slider", {
                    ...
                    if (data) {
                        ...
                        $(".crafito_blog_slider").removeClass('o_hidden');
    ...
    animation.registry.s_theme_crafito_client_slider_snippet = animation.Class.extend({
        ...
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $client_slider = $('#wrapwrap').find('#theme_crafito_custom_client_slider');
    ...
    animation.registry.theme_crafito_multi_cat_custom_snippet = animation.Class.extend({
        ...
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $cat_custom = $('#wrapwrap').find('#theme_crafito_custom_multi_product_tab_slider');
    ...
    animation.registry.theme_crafito_category_slider = animation.Class.extend({
        ...
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $cate_slider = $('#wrapwrap').find('#theme_crafito_custom_category_slider');
    ...
    animation.registry.biztech_new_theme_fact_sheet_jsselector = animation.Class.extend({
        ...
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $skill_selector = $('#wrapwrap').find('.s_theme_crafito_facts_sheet');
    ...
    animation.registry.biztech_new_theme_skill_jsselector = animation.Class.extend({
        ...
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $skill_selector = $('#wrapwrap').find('.s_theme_crafito_skills');
    ...
    animation.registry.s_biztech_new_theme_team_two = animation.Class.extend({
        ...
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $team_two = $('#wrapwrap').find('#theme_crafito_custom_second_team');
    ...
    animation.registry.s_biztech_new_theme_team_one = animation.Class.extend({
        ...
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $team_one = $('#wrapwrap').find('#theme_crafito_custom_colthree_team');
    ...
    animation.registry.s_biztech_new_theme_team_three = animation.Class.extend({
        ...
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $team_three = $('#wrapwrap').find('#theme_crafito_three_custom_team');
    ...
    animation.registry.theme_crafito_news1_js = animation.Class.extend({
        ...
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $news1 = $('#wrapwrap').find('#theme_crafito_custom_news1');
            ...
            if (!this.editableMode) {
                ...
                $.get("/theme_crafito/newsone_get_dynamic_slider", {
                    ...
                    if (data) {
                        self.$target.empty();
                        self.$target.append(data);
                        $(".crafito_newsone_slider").removeClass('o_hidden');
                    }
                });
            }
        }
    ...
    animation.registry.theme_crafito_news2_js = animation.Class.extend({
        ...
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $news2 = $('#wrapwrap').find('#theme_crafito_custom_second_news');
            ...
            if (!this.editableMode) {
                ...
                $.get("/theme_crafito/newstwo_get_dynamic_slider", {
                    ...
                    if (data) {
                        self.$target.empty();
                        self.$target.append(data);
                        $(".crafito_newstwo_slider").removeClass('o_hidden');
                    }
                });
            }
        }
    ...
    animation.registry.theme_crafito_hardware_blog_snippet = animation.Class.extend({
        ...
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $blog_snipet = $('#wrapwrap').find('#theme_crafito_hardware_blog_inner_containt'); 
            ...
            if (!this.editableMode) {
                ...
                $.get("/theme_crafito/theme_new_hardware_blog", {
                    ...
                    if (data) {
                        self.$target.empty();
                        self.$target.append(data);
                        $(".theme_crafito_new_blog").removeClass('o_hidden');
                    }
                });
            }
        }
    ...
    animation.registry.s_theme_crafito_events = animation.Class.extend({
        ...
        start: function() {
            var self = this;
            if (this.editableMode) {
                var $events= $('#wrapwrap').find('#theme_crafito_custom_event_category');
