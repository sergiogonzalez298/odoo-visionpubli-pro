...
class WebsiteMenu(models.Model):
    ...
    megamenu_bg_image_filename = fields.Char(
        "Background image for megamenu Filename")
...
class website(models.Model):
    ...
    # For brandcum image
    king_breadcrumb_img = fields.Binary(string='Breadcrumb Background Image')
...
class ResConfigSettings(models.TransientModel):
    ...
    king_breadcrumb_img = fields.Binary(
        related="website_id.king_breadcrumb_img", readonly=False)
